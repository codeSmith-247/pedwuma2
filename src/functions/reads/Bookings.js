...
import { collection, getDocs, query, where, and, getCountFromServer, orderBy, Timestamp, limit } from "firebase/firestore";
...
export const useBookingProfiles = (page=1) => {

    const auth = getAuth();

    return useQuery(['booking profiles', page], async () => {

            ...
            resultUi={ (item) =>
                <div>
                    {safeGet(item, ["Services Provided"], []).map( (sub, subIndex) => 
                        <div key={subIndex} onClick={() => {callback(sub); setSearchInput(safeGet(sub, ["Title"], ""))}} className="px-5 py-3 text-md hover:bg-gray-200 active:bg-blue-600 active:text-white">
